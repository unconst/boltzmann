...
pm2 start master.py --interpreter python3 --name MASTER -- --wallet.name Alice --wallet.hotkey Alice --subtensor.network test --device cuda:0 --use_wandb 
pm2 start validator.py --interpreter python3 --name VA -- --wallet.name Alice --wallet.hotkey Alice --subtensor.network test --device cuda:1 --use_wandb
