...
pm2 start validator.py --interpreter python3 --name V1 -- --wallet.name Alice --wallet.hotkey Alice --subtensor.network test --device cuda:0 --use_wandb --restart
pm2 start validator.py --interpreter python3 --name V2 -- --wallet.name Alice --wallet.hotkey Bob --subtensor.network test --device cuda:1 --use_wandb --restart
