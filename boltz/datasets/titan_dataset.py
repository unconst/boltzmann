...
class HuggingFaceDataset(IterableDataset, Stateful):
    ...
    Args:
        ...
        tokenizer (Tokenizer):
            Tokenizer used to encode data. Tokenizer must implement an `encode` and `decode` method.
    ...
    Example use (c4):
    >>> ds = HuggingFaceDataset(dataset_name="c4", dataset_path=None, tokenizer=tokenizer, seed=12345)
    ...
    def __init__(
        ...
        sampling_probability: float = 1.0,  # Control the sampling rate
    ) -> None:
        ...
        while True:
            ...
            for idx, sample in enumerate(sample_iter):
                ...
                if self._should_include_sample(sample_index):
                    ...
                    self._sample_idx += 1  # Increment only when we process a sample
